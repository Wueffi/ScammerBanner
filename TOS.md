...
This Terms of Service Agreement (the "Agreement") is entered into between the bot owner ("Bot Owner") and the user ("User") of the ScammerBanner Discord bot (the "Bot").
